...
function Contact() {
    ...
    if (state.succeeded) {
        ...
        <button className="button is-medium isprimary is-half m-6" onClick={() => window.open("/#contact")}>Back to About</button>
        </div>
        );
    }
    ...
    return (
        <div>
            ...
            <form id="contact-form" onSubmit={handleSubmit}>
                ...
                <button className="button is-medium is-primary is-fullwidth" type="submit" data-testid="button" type="submit">Submit</button>
            </form>
        </div>
    );
}
